const CACHE = 'dsl-app-shell-v1';
const SHELL = ['/app/', '/app/index.html', '/app/manifest.json', '/icon-192.png', '/icon-512.png'];
...
self.addEventListener('fetch', e => {
  ...
  if (e.request.mode === 'navigate' || url.pathname === '/app/' || url.pathname === '/app/index.html') {
    e.respondWith(
      fetch(e.request)
